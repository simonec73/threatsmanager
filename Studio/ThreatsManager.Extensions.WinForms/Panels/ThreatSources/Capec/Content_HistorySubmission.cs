...
public partial class Content_HistorySubmission
{
    ...
    {
        get => _submitter_Organization;
        set => _submitter_Organization = value;
    }
    
    [XmlElement(DataType="date")]
    public DateTime Submission_Date
    {
        get => _submission_Date;
        set => _submission_Date = value;
    }
    
    public string Submission_Comment
    {
        get => _submission_Comment;
        set => _submission_Comment = value;
    }
    
    [XmlAttribute]
    public Content_HistorySubmissionSubmission_Source Submission_Source
    {
        get => _submission_Source;
        set => _submission_Source = value;
    }
}
}
