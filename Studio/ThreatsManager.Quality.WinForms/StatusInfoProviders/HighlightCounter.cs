...
{
    [Extension("EC3DE1A2-2263-4F26-8524-CBE74743EA39", "Highlight Counter Status Info Provider", 156, ExecutionMode.Simplified)]
    public class HighlightCounter : IStatusInfoProviderExtension
    {
        ...
        public string Description => "Counter of the Highlights defined in the Threat Model.";
