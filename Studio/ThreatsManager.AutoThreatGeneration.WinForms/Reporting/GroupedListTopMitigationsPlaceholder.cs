...
using ListItem = ThreatsManager.Extensions.Reporting.ListItem;

namespace ThreatsManager.AutoThreatGeneration.Reporting
{
    [Extension("A2460D25-21A1-454E-A164-4674BE35F02B", "Grouped Top Mitigation List Placeholder", 44, ExecutionMode.Business)]
    public class GroupedListTopMitigationsPlaceholderFactory : IPlaceholderFactory
    {
        public string Qualifier => "GroupedListTopMitigations";

        public IPlaceholder Create(string parameters = null)
        {
            var placeholder = new GroupedListTopMitigationsPlaceholder();
    ...
    public class GroupedListTopMitigationsPlaceholder : IGroupedListPlaceholder
    {
        public string Name => "TopMitigationsGrouped";
        public string Label => "Top Mitigations (grouped)";
