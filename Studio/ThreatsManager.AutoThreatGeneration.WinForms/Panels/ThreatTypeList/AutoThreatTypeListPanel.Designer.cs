...
{
    partial class AutoThreatTypeListPanel
    {
        /// <summary> 
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (rows.Any())
            {
                foreach (var row in rows)
                {
                    ...
                    var bc2 = row.Rows.OfType<GridPanel>().FirstOrDefault()?
                        .Columns["AutoGenRule"].EditControl as GridButtonXEditControl;
                    if (bc2 != null)
                    {
                        bc2.Click -= BcMitigationButtonClick;
                    }
                }
            }
        ...
        private void InitializeComponent()
        {
            ...
            this._ruleFilter.Location = new System.Drawing.Point(352, 4);
            ...
            this._specialFilter.Location = new System.Drawing.Point(178, 4);
            this._specialFilter.Margin = new System.Windows.Forms.Padding(0);
            this._specialFilter.Name = "_specialFilter";
            this._specialFilter.Size = new System.Drawing.Size(162, 21);
            this._specialFilter.TabIndex = 1;
            // 
            // _apply
            // 
            this._apply.Location = new System.Drawing.Point(436, 4);
            ...
            this._filter.Size = new System.Drawing.Size(134, 20);
            ...
            this.Name = "AutoThreatTypeListPanel";
