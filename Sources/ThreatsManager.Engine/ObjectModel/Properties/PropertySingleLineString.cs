...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class PropertySingleLineString : IPropertySingleLineString
    {
        ...
        public IProperty Clone(IPropertiesContainer container)
        {
            ...
            if (model != null)
            {
                ...
                if (propertyType != null)
                {
                    ...
                    if (schema != null)
                    {
                        ...
                        {
                            var containerPropertyType = containerSchema.GetPropertyType(propertyType.Name) as ISingleLineStringPropertyType;
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Property Single Line String"))
                {
                    result = new PropertySingleLineString()
                    {
                        _id = Id,
