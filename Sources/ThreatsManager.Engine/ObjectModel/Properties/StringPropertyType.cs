...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    [Undoable]
    [AssociatedPropertyClass("ThreatsManager.Engine.ObjectModel.Properties.PropertyString, ThreatsManager.Engine")]
    public class StringPropertyType : IStringPropertyType
    {
        ...
        public IPropertyType Clone([NotNull] IPropertyTypesContainer container)
        {
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone String Property Type"))
                {
                    result = new StringPropertyType
                    {
                        _id = _id,
                        _schemaId = schema.Id,
                        _model = schema.Model,
