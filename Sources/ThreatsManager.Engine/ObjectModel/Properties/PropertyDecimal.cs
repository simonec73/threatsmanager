...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class PropertyDecimal : IPropertyDecimal
    {
        ...
        public IProperty Clone(IPropertiesContainer container)
        {
            ...
            if (model != null)
            {
                ...
                if (propertyType != null)
                {
                    ...
                    if (schema != null)
                    {
                        ...
                        {
                            var containerPropertyType = containerSchema.GetPropertyType(propertyType.Name) as IDecimalPropertyType;
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Property Decimal"))
                {
