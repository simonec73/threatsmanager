...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class ShadowPropertyDate : PropertyDate, IShadowProperty
    {
        public ShadowPropertyDate()
        {

        }

        public ShadowPropertyDate([NotNull] IPropertyDate original) : base(original.PropertyType as IDatePropertyType)
        {
        ...
        public override DateTime Value
        {
            get
            {
                ...
                if (!_overridden)
                {
                    if (Original is IPropertyDate originalProperty)
