...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class PropertyArray : IPropertyArray, IInitializableObject
    {
        ...
        public IProperty Clone(IPropertiesContainer container)
        {
            ...
            if (model != null)
            {
                ...
                if (propertyType != null)
                {
                    ...
                    if (schema != null)
                    {
                        ...
                        {
                            var containerPropertyType = containerSchema.GetPropertyType(propertyType.Name) as IArrayPropertyType;
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Property Array"))
                {
                    result = new PropertyArray()
                    {
                        _id = Id,
