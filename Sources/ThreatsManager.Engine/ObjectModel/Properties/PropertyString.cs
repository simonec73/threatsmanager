...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class PropertyString : IPropertyString
    {
        ...
        public IProperty Clone(IPropertiesContainer container)
        {
            ...
            if (model != null)
            {
                ...
                if (propertyType != null)
                {
                    ...
                    if (schema != null)
                    {
                        ...
                        {
                            var containerPropertyType = containerSchema.GetPropertyType(propertyType.Name) as IStringPropertyType;
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Property String"))
                {
