...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    [Undoable]
    [AssociatedPropertyClass("ThreatsManager.Engine.ObjectModel.Properties.PropertyUrl, ThreatsManager.Engine")]
    public class UrlPropertyType : IUrlPropertyType
    {
        ...
        public UrlPropertyType([Required] string name, [NotNull] IPropertySchema schema) : this()
        {
            _id = Guid.NewGuid();
            _schemaId = schema.Id;
            _model = schema.Model;
        ...
        public IPropertyType Clone([NotNull] IPropertyTypesContainer container)
        {
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Url Property Type"))
                {
                    result = new UrlPropertyType
                    {
                        _id = _id,
                        _schemaId = schema.Id,
                        _model = schema.Model,
