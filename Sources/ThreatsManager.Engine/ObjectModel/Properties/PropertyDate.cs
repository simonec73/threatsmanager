...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class PropertyDate : IPropertyDate
    {
        ...
        public IProperty Clone(IPropertiesContainer container)
        {
            ...
            if (model != null)
            {
                ...
                if (propertyType != null)
                {
                    ...
                    if (schema != null)
                    {
                        ...
                        {
                            var containerPropertyType = containerSchema.GetPropertyType(propertyType.Name) as IDatePropertyType;
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Property Date"))
                {
