...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    [Undoable]
    [AssociatedPropertyClass("ThreatsManager.Engine.ObjectModel.Properties.PropertyDate, ThreatsManager.Engine")]
    public class DatePropertyType : IDatePropertyType
    {
        ...
        public DatePropertyType([Required] string name, [NotNull] IPropertySchema schema) : this()
        {
            _id = Guid.NewGuid();
            _schemaId = schema.Id;
            _model = schema.Model;
        ...
        public IPropertyType Clone([NotNull] IPropertyTypesContainer container)
        {
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Date Time Property Type"))
                {
                    result = new DatePropertyType
                    {
                        _id = _id,
                        _schemaId = schema.Id,
                        _model = schema.Model,
