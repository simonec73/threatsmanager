...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class ShadowPropertyUrlList : PropertyUrlList, IShadowProperty
    {
        public ShadowPropertyUrlList()
        {

        }

        public ShadowPropertyUrlList([NotNull] IPropertyUrlList original) : base(original.PropertyType as IUrlListPropertyType)
        {
