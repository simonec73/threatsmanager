...
namespace ThreatsManager.Engine.ObjectModel.Properties
{
    ...
    public class DecimalPropertyType : IDecimalPropertyType
    {
        ...
        public DecimalPropertyType([Required] string name, [NotNull] IPropertySchema schema) : this()
        {
            _id = Guid.NewGuid();
            _schemaId = schema.Id;
            _model = schema.Model;
        ...
        public IPropertyType Clone([NotNull] IPropertyTypesContainer container)
        {
            ...
            {
                using (var scope = UndoRedoManager.OpenScope("Clone Decimal Property Type"))
                {
                    result = new DecimalPropertyType
                    {
                        _id = _id,
                        _schemaId = schema.Id,
                        _model = schema.Model,
