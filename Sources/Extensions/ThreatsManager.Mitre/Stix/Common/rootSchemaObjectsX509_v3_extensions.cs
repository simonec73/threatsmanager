...
[DebuggerStepThrough]
[Newtonsoft.Json.JsonObjectAttribute("rootSchemaObjectsX509_v3_extensions", MemberSerialization=MemberSerialization.OptIn)]
public partial class rootSchemaObjectsX509_v3_extensions
{
    ...
    /// <summary>
    /// Serializes current rootSchemaObjectsX509_v3_extensions object into an json string
    /// </summary>
    ...
    /// <summary>
    /// Deserializes rootSchemaObjectsX509_v3_extensions object
    /// </summary>
    /// <param name="input">string workflow markup to deserialize</param>
    /// <param name="obj">Output rootSchemaObjectsX509_v3_extensions object</param>
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool Deserialize(string input, out rootSchemaObjectsX509_v3_extensions obj, out Exception exception)
    {
        exception = null;
        obj = default(rootSchemaObjectsX509_v3_extensions);
        try
        {
    ...
    public static bool Deserialize(string input, out rootSchemaObjectsX509_v3_extensions obj)
    {
        Exception exception = null;
        return Deserialize(input, out obj, out exception);
    }
    
    public static rootSchemaObjectsX509_v3_extensions Deserialize(string input)
    {
        Newtonsoft.Json.JsonSerializerSettings settings = new Newtonsoft.Json.JsonSerializerSettings();
        return JsonConvert.DeserializeObject<rootSchemaObjectsX509_v3_extensions>(input, settings);
    }
    #endregion
    ...
    public static rootSchemaObjectsX509_v3_extensions LoadFromFile(string fileName)
    {
