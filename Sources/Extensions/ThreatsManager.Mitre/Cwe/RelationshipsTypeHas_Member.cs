...
public partial class RelationshipsTypeHas_Member
{
    ...
    private static XmlSerializer Serializer
    {
        get
        {
            if ((serializer == null))
            {
                serializer = new XmlSerializerFactory().CreateSerializer(typeof(RelationshipsTypeHas_Member));
            }
            return serializer;
        }
    }
    ...
    /// <summary>
    /// Serializes current RelationshipsTypeHas_Member object into an XML string
    /// </summary>
    ...
    /// <summary>
    /// Deserializes workflow markup into an RelationshipsTypeHas_Member object
    /// </summary>
    ...
    public static RelationshipsTypeHas_Member Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((RelationshipsTypeHas_Member)(Serializer.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((RelationshipsTypeHas_Member)(Serializer.Deserialize(s)));
    }
    #endregion
