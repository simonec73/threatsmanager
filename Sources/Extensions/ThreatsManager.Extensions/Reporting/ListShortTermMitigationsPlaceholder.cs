...
{
    [Extension("783DAECE-DDC6-4388-BC3A-86B94B787DDB", "Short Term Mitigation List Placeholder", 44, ExecutionMode.Business)]
    public class ListShortTermMitigationsPlaceholderFactory : IPlaceholderFactory
    {
        public string Qualifier => "ListShortTermMitigations";

        public IPlaceholder Create(string parameters = null)
        {
            return new ListShortTermMitigationsPlaceholder();
        }
    }

    public class ListShortTermMitigationsPlaceholder : IListPlaceholder
    {
