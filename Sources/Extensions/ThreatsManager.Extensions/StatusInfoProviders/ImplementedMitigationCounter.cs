...
{
    [Extension("39B0886D-B6C1-4562-A504-9CC882D93024", "Implemented Mitigation Counter Status Info Provider", 37, ExecutionMode.Simplified)]
    public class ImplementedMitigationCounter : IStatusInfoProviderExtension
    {
        ...
        public string CurrentStatus =>
            $"Implemented Mitigations: {(_model.GetThreatEventMitigations()?.Where(x => x.Status == MitigationStatus.Implemented).Count() ?? 0)}";

        public string Description => "Counter of the Threat Event Mitigations with status Implemented.";
        ...
        {
            return "Implemented Mitigation Counter";
        }
